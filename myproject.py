...
from apps.common.qiniuyun import bp as common_bp
import os
import string
import time
import hashlib
    ...
    if action == 'config':
        ...
        if UEDITOR_UPLOAD_TO_QINIU:
            ...
            if info.ok:
                ...
                result['url'] = "http://pg438m4az.bkt.clouddn.com/"+ret['key']
                result['title'] = ret['key']
                result['original'] = "http://pg438m4az.bkt.clouddn.com/"+ret['key']
        else:
